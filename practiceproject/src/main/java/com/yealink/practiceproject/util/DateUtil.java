...
public class DateUtil {
    ...
    public static long getYMDTimeStamp(String date) {
        return getTimeStamp(date, ConstantPool.DateFormat.YMD_FORMAT);
    }
    ...
    public static long mergeYMDHMTimeStamp(String date, String time) {
        return getTimeStamp(date + ConstantPool.DateFormat.SPACE + time, ConstantPool.DateFormat.YMDHM_FORMAT);
    }


    public static long getYMDHMTimeStamp(String date) {
        return getTimeStamp(date, ConstantPool.DateFormat.YMDHM_FORMAT);
    }
    ...
    public static String getYMDDate(long timestamp) {
        return getDate(timestamp, ConstantPool.DateFormat.YMD_FORMAT);
    }
