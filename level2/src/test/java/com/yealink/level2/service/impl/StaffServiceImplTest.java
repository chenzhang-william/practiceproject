...
import com.yealink.level2.domain.StaffMapper;
import com.yealink.level2.service.EnterpriseService;
...
//        doReturn(mockStaff).when(mockStaffService.findStaffByMobile(mockStaff));
    ...
    public void genderTransferTest(){
        assertEquals(1,mockStaffService.genderTransfer("男"));
        assertEquals(2,mockStaffService.genderTransfer("女"));
        assertEquals(0,mockStaffService.genderTransfer("12313213213"));
    }
    @Test
